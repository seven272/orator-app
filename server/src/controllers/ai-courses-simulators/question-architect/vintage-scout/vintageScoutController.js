...
const startVintageScoutTrainer = async (req, res) => { 
  try {
    ...
    const preview = `Вы начинаете диалог с целью глубинной разведки информации. Ваша цель: ${exerciseData.role}. Тема: "${exerciseData.topic}".\n${exerciseData.context}\n\nСобеседник настроен настороженно, внимательно осматривает вас и ждет ваших вопросов...`;
