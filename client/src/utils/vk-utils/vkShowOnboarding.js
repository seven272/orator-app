      ...
      slides: [
        {
          ...
          subtitle:
            'GovoriX — ваш персональный тренер по риторике. Уникальные речевые тренажеры,доступная теория, игровая подача, обширная статистика. Запускайте первый тренажер и говорите уверенно!',
        },
      ],
    })
