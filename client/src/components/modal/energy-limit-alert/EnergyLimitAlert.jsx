...
const EnergyLimitAlert = () => {
  ...
  const isPremiumOfferOpen = useSelector(
    (state) => state.exercise.isPremiumOfferOpen,
  )
    ...
    >
      ...
      >
        ...
        <p className={styles.modal_description}>
          Ваш суточный лимит бесплатной энергии (
          <span className={styles.highlight_blue}>15 единиц</span>) на
          сегодня полностью израсходован. Но завтра он снова
          восстановится.
        </p>

        <p className={styles.modal_description}>
          Оформите подписку{' '}
          <span className={styles.highlight_blue}>Premium</span>,
          чтобы отключить любые ограничения, открыть мгновенный доступ
          к продвинутым ИИ-тренажерам 3-го уровня и тренироваться без
          пауз!
        </p>
