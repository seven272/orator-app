...
useEffect(() => {
  ...
  if (!isAuth && !isVkGuest) {
    ...
    if (!savedDate || savedDate !== todayStr) {
      ...
      const currentEnergy = savedEnergy !== null ? parseInt(savedEnergy, 10) : 3
      ...
      <div className={styles.header}>
        <div className={styles.header_wrapper}>
          ...
          <div className={styles.right_block}>
            ...
            {isVkGuest ? (
              /* 🎁 Вариант А: Кнопка быстрой регистрации для гостей ВК */
              <button
                type="button"
              ...
              /* 😎 Вариант Б: Компонент аватара (сам управляет заглушкой и ссылкой на /auth для гостей) */
              <AvatarOrPlaceholder
