...
import ChatPoemTongue from './chat-poem-tongue/ChatPoemTongue' 
...
const PoemTongueProcess = ({
  ...
  // Перезапуск таймера и принудительное тушение звука при старте записи нового дубля
  useEffect(() => {
  ...
  return (
    <div className={styles.screen_running}>
      ...
      <div className={styles.session_footer}>
        ...
        {/* Обновленный финал: двухкнопочная группа плеера и завершения */}
