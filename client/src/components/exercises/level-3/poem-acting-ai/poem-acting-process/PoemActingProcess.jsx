...
const PoemActingProcess = ({
  ...
  // Сброс таймера и принудительное тушение звука при старте записи нового дубля
  useEffect(() => {
  ...
  return (
    <div className={styles.screen_running}>
      ...
      <div className={styles.session_footer}>
        ...
        {/* Обновленный финал дубля: двухкнопочная группа плеера и завершения */}
          ...
          <div className={styles.finished_actions_group}>
            {audioUrl && (
              ...
              >
                ...
                <span>{isPlaying ? 'Пауза' : 'Слушать дубль'}</span>
              </button>
            )}
